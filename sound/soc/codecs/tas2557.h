...
#define TAS2557_CRC_CHECKSUM_REG		TAS2557_REG(0, 0, 32) /* B0_P0_R0x20 */
#define TAS2557_CRC_RESET_REG			TAS2557_REG(0, 0, 33) /* B0_P0_R0x21 */
#define TAS2557_DSP_MODE_SELECT_REG		TAS2557_REG(0, 0, 34)
#define TAS2557_SAFE_GUARD_REG			TAS2557_REG(0, 0, 37)	/* B0_P0_R0x25 */
...
#define TAS2557_POWER_UP_FLAG_REG		TAS2557_REG(0, 0, 100)	/* B0_P0_R0x64 */
...
#define TAS2559_SLEEPMODE_CTL_REG		TAS2557_REG(0, 2, 7)
...
#define TAS2557_SA_CHL_CTRL_REG			TAS2557_REG(0, 53, 20) /* B0_P0x35_R0x14 */
...
#define TAS2559_VBST_VOLT_REG			TAS2557_REG(0, 253, 58) /* B0_P0xfd_R0x3a */
...
#define TAS2557_VBOOST_CTL_REG			TAS2557_REG(100, 0, 64)	/* B0x64_P0x00_R0x40 */

/* B0x82_P0x02_R0x7C */
#define TAS2557_DIE_TEMP_REG			TAS2557_REG(130, 2, 124) /* B0x82_P0x02_R0x7C */
#define TAS2557_DEVA_CALI_R0_REG		TAS2557_REG(140, 47, 40) /* B0x8c_P0x2f_R0x28 */
#define TAS2557_DEVB_CALI_R0_REG		TAS2557_REG(140, 54, 12) /* B0x8c_P0x36_R0x0c */
...
#define	TAS2557_AD_BD		0	/* DevA default, DevB default */
#define	TAS2557_AM_BM		1	/* DevA mute, DevB mute */
#define	TAS2557_AL_BR		2	/* DevA left channel, DevB right channel */
#define	TAS2557_AR_BL		3	/* DevA right channel, DevB left channel */
#define	TAS2557_AH_BH		4	/* DevA (L+R)/2, DevB (L+R)/2 */
...
/* both DevA and DevB always 8.5V */
#define	TAS2557_VBST_A_ON_B_ON		(TAS2557_VBST_A_ON | TAS2557_VBST_B_ON)
#define	TAS2557_VBST_NEED_DEFAULT	0xff	/* need default value */

#define	TAS2557_VBST_8P5V	0	/* corresponding PPG 0dB */
#define	TAS2557_VBST_8P1V	1	/* corresponding PPG -1dB */
#define	TAS2557_VBST_7P6V	2	/* corresponding PPG -2dB */
#define	TAS2557_VBST_6P6V	3	/* corresponding PPG -3dB */
#define	TAS2557_VBST_5P6V	4	/* corresponding PPG -4dB */

#define TAS2557_YRAM_BOOK1				140 /* 0x8c */

#define TAS2557_YRAM1_PAGE				42 /* 0x2a */
#define TAS2557_YRAM1_START_REG			88
#define TAS2557_YRAM1_END_REG			127

#define TAS2557_YRAM2_START_PAGE		43	/* 0x2b */
...
#define TAS2557_YRAM4_START_PAGE		50	/* 0x32 */
#define TAS2557_YRAM4_END_PAGE			60	/* 0x3c */
#define TAS2557_YRAM4_START_REG			8
#define TAS2557_YRAM4_END_REG			127

#define TAS2557_YRAM5_PAGE				61	/* 0x3d */
#define TAS2557_YRAM5_START_REG			8
#define TAS2557_YRAM5_END_REG			27

#define TAS2557_YRAM_BOOK3				120	/* 0x78 */
#define TAS2557_YRAM6_PAGE				12	/* 0x0c */
#define TAS2557_YRAM6_START_REG			104	/* 0x68 */
#define TAS2557_YRAM6_END_REG			107	/* 0x6b */
...
#define	TAS2560_BCLKINV				BIT(2)
#define	TAS2560_WCLKINV				BIT(3)
#define	TAS2560_BCLKDIR				BIT(4)
#define	TAS2560_WCLKDIR				BIT(5)
...
#define	TAS2560_VBST_VOLT_REG		TAS2557_REG(0, 253, 54)	/* B0_P0xfd_R0x36 */
